...
\begin{table}[t]
    ...
    \begin{tabular}{lrrrr}
        \toprule
        \textbf{Duration bin} & \textbf{Samples} & \textbf{MAE (h)} & \textbf{$>$100\,h rate} \\
        \midrule
        $[0, 24)$\,h     & 324,006  & 2.45  & 0.000\% \\
        $[24, 72)$\,h    & 409,819  & 6.52  & 0.045\% \\
        $[72, 168)$\,h   & 743,545  & 10.66 & 0.225\% \\
        $[168, 336)$\,h  & 980,279  & 19.71 & 1.649\% \\
        $[336, 504)$\,h  & 384,803  & 28.48 & 3.270\% \\
        $[504, 720)$\,h  & 17,436   & 92.06 & \textbf{36.24\%} \\
        \midrule
